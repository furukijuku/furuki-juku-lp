 ...
 * 公開ラベル: v1.0 初公開 → Git タグ furuki-lp-v1.0 が指すコミットのスナップショットです。
...
$testimonials = [
  [
    ...
    'name'     => '江東区中3Rくん',
    'grade'    => '中学3年生（本人）',
    'title'    => '塾で予習したところが授業で出て、解けた！',
    'body'     => '家だと集中が続かないけど、塾は静かで集中しやすいです。塾で予習したところが授業に出て解けた時は「あ、わかった！」ってなります。勉強のスイッチが入る場所です。',
  ],
  [
    'category' => 'junior-high-parent',
    'avatar'   => '👩',
    'name'     => 'サクラサク',
    'grade'    => '小学5年生・中学2年生兄弟・保護者',
    'title'    => '兄弟で通っています。個性を大切にした指導に安心しています',
    'body'     => '兄弟で通っています。子どもが自分で考える時間を大切にしながら、適切な声がけをしてもらえるところが入塾の決め手でした。今では親が言わなくても自分で準備して遅れずに通塾できています。個性を受け止め、体調まで気にかけてくれるところにも安心しています。',
  ],
  [
    'category' => 'junior-high-parent',
    'avatar'   => '👨',
    'name'     => '中2男子保護者',
    'grade'    => '中学2年生・保護者',
    'title'    => '不登校気味でも、ストレスなく通えています',
    'body'     => 'お姉ちゃんがFuruki塾に通って高校に進学した実績があったこともあり、入塾前から信頼感がありました。体験を通して本人も楽しさや分かりやすさを感じたことで入塾を決めました。不登校気味のため、学校を休んだ時に早い時間へ変更してもらうなど柔軟な対応が大変ありがたいです。心地のいい環境とちょうどいい距離感で接してくれるので、ストレスなく勉強できています。',
  ],
  [
    'category' => 'junior-high-parent',
    'avatar'   => '👩',
    'name'     => '中1保護者',
    'grade'    => '中学1年生・保護者',
    'title'    => '塾で長く集中できるようになり、達成感を持って帰ってきます',
    'body'     => '自宅学習が定着しないことが悩みでしたが、塾では長い時間勉強できるようになりました。いつも達成感があるようで、親身になって話を聞いてくれる先生のおかげで保護者としても安心しています。',
  ],
  [
    'category' => 'junior-high-parent',
    'avatar'   => '👩',
    'name'     => '中1・中3保護者',
    'grade'    => '中学1年生・中学3年生兄弟・保護者',
    'title'    => '兄弟で通っています。本人を見てくれる、本当の個別指導です',
    'body'     => '兄弟で通っています。塾長とお話しして、考え方や教育のアプローチに共感し信頼できました。上の子が中学の課題に取り組む様子を誇らしげに話してくれたのが印象的でした。過度なプレッシャーがかからず、継続して課題に取り組めるようになっています。',
  ],
  [
    'category' => 'junior-high-parent',
    'avatar'   => '👩',
    'name'     => '中3保護者',
    'grade'    => '中学3年生・保護者',
    'title'    => '塾長が変わらず、一人ひとりをよく見てくれています',
    'body'     => '毎日の勉強習慣をつけたかったのですが、少しずつ机に向かえるようになりました。少人数で一人ひとりをよく観察してくれており、親では気づけなかったことを気づかせてもらえることもあります。',
  ],
  [
    'category' => 'junior-high-parent',
    'avatar'   => '👩',
    'name'     => '中2保護者',
    'grade'    => '中学2年生・保護者',
    'title'    => '部活の予定に合わせて自由に通えるのが助かっています',
    'body'     => '英語のスタートでつまずいてしまったことが悩みでしたが、自由に時間を組めるため部活の予定に合わせて通えています。家から近いことも続けやすい理由のひとつです。',
  ],
  [
    ...
    'name'     => '小６保護者',
    'grade'    => '小学6年生・保護者',
    'title'    => '押し付けない、見守る指導が子どもにぴったりでした',
    'body'     => '得意・苦手に合わせて指導内容を変えてくださり、困っている時に声がけしてくださるのが子どもにとても合っていて安心しています。塾から帰ると、その日の達成と先の目標を楽しそうに話してくれます。進んで通えているのが一番の成長です。',
  ],
  [
    'category' => 'elementary-parent',
    'avatar'   => '👩',
    'name'     => '勉強嫌いなの母',
    'grade'    => '小学6年生・保護者',
    'title'    => '子どもの特性を理解して指導してくれることに安心しています',
    'body'     => '勉強の仕方がわからないことが悩みでした。子どもの特性を理解した上で指導してくれているので、保護者として安心しています。少しずつですが、自分から漢字を書いてみるようになるなど変化も見えてきました。',
  ],
];
?><!DOCTYPE html>
<html lang="ja">
...
<section class="section" id="voice">
  <div class="container">
    ...
    <div class="t-note">
      掲載にご協力いただいた保護者・生徒の皆様、ありがとうございました。<br>
      ※個人が特定されないよう、ペンネームまたは匿名で掲載しています。
    </div>
  </div>
</section>
